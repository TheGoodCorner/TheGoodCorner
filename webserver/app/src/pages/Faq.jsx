...
export default function Faq() {
  return (
    <div className="min-h-screen bg-[#0b0f19] text-gray-300 py-12 px-6 sm:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Encadré d'avertissement projet 42 */}
        <div className="bg-[#131b2e] border border-gray-800 rounded-lg p-4 mb-12 text-sm text-gray-400">
              ...
              <ul className="space-y-2 mt-3 text-sm">
                {FAQ_SECTIONS.map((section) => (
                  <li key={section.id}>
                    <a
                      href={`#${section.id}`}
                      className="text-gray-400 hover:text-white transition-colors duration-150 block py-0.5"
                    >
                      {section.label}
                    </a>
                  </li>
